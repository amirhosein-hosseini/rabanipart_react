    ...
    return(
        <Link to={"/shop/123"}>
            <div className={styles.shopItem + " border max-md:h-full border-black max-md:border-none max-md:flex max-md:items-center max-md:gap-5"}>
                ...
                <div className={styles.footer + " relative z-20 bg-[#3870B2] max-md:bg-transparent flex flex-col max-md:justify-between h-[70%] w-full p-3 border-b-4 border-b-[#3870B2]"} style={{direction : "ltr"}}>
                    <div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className={styles.price + " flex items-center justify-between w-full"}>
                            ...
                            <div className="flex items-center gap-1">
                                <p className="text-white text-[10px] max-md:text-[12px] flex max-md:text-black"><span>قیمت : </span>۲۰۰۰،۰۰۰ </p>
