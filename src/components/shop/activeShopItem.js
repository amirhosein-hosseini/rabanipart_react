...
const ActiveShopItem = () => {
    return(
        <div className={styles.shopItem + " border border-black"}>
            <div className={styles.image + " relative z-10 w-full overflow-hidden"}>
                <img className="object-cover w-full h-full" src="../../images/shopitemimage.png" alt="image" />
            </div>
            <div className={styles.footer + " relative z-20 bg-[#3870B2] flex items-center w-full p-3 justify-between"}>
                <div className={styles.price + " flex flex-col gap-1"}>
                    <div className="flex items-center gap-1">
                        ...
                        <p className="text-white text-[10px] flex"><span>قیمت : </span>۲۰۰۰،۰۰۰ </p>
                    </div>
                    <div className="flex items-center gap-1">
                        ...
                        <p className="text-white text-[7px]">اطلاعات بیشتر</p>
                    </div>
                </div>
                <div className={styles.desc + " flex flex-col gap-1"}>
                    <p className="text-white text-[8px]">الکتریکی</p>
                    <p className="text-white text-[18px]">دینام</p>
                </div>
            </div>
        </div>
    )
