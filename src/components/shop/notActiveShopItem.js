...
const NotActiveShopItem = ({image , price , title , slug}) => {
    ...
    return(
        <Link to={"/product/" + slug}>
            <div className={styles.shopItem + " border border-[#eee] p-2 max-md:h-full max-md:border-none max-md:flex max-md:items-center max-md:gap-5"}>
                ...
                <div className={styles.footer + " relative h-full z-20 max-md:bg-transparent flex flex-col max-md:justify-between h-[70%] w-full p-3"} style={{direction : "ltr"}}>
                    <div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className={styles.price + " flex items-center justify-between w-full"}>
                            <div className="flex items-center gap-1">
                                ...
                                <p className="text-[#EB0E23] text-[7px] max-md:text-[10px] max-md:text-[#EB0E23] font-bold">اطلاعات بیشتر</p>
                            </div>
                            <div className="flex items-center gap-1">
                                {price !== undefined ? <p className="text-black text-[10px] max-md:text-[12px] flex max-md:text-black"><span>قیمت : </span>{price}</p> : ""}
