...
const ArchiveBlog = () => {
    ...
    return(
        <div className={styles.archiveBlog + " mt-20"}>
            <div className={styles.header + " container w-11/12 max-w-7xl mx-auto max-h-[380px] overflow-hidden rounded-br-[135.77px] max-md:rounded-br-[0px]"}>
                <img className="object-contain w-full max-h-[380px]" src="../../images/blogheader.png" alt="image" />
            </div>

            <div className={styles.items + " container max-w-7xl w-11/12 mx-auto  mt-20 grid grid-cols-2 max-lg:grid-cols-1 gap-5"} style={{direction : "rtl"}}>
                {blogs?.map((item) => (
