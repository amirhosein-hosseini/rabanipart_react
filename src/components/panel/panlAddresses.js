    ...
    return(
        <div className={styles.panelOrder + " px-5 py-12 max-md:py-5"}>
            ...
            <div className={styles.items + " mb-10"}>
                <div className={styles.item + " border-b-2 border-b-[#eee] pb-3 flex flex-row-reverse gap-2"}>
                    ...
                    <div className={styles.desc + " flex flex-col gap-2"}>
                        <p className="text-sm max-md:text-xs">قزوین</p>
                        <p className="text-sm max-md:text-xs">قزوین میدان جانبازان بلوار نخبگان کوچه پرتو کوچه گوهرشاد خانم پلاک ۲۹</p>
                        <p className="text-sm max-md:text-xs">۳۴۱۵۸۵۱۹۲۰</p>
                        <p className="text-sm max-md:text-xs">۰۹۱۰۷۵۰۲۹۰۷</p>
                        <p className="text-sm max-md:text-xs">محمد پیله چی</p>
                    </div>
                </div>
