...
const Header = ({background}) => {
    ...
    return(
        <div className={`${styles.header} ${styles.sticky} bg-${scrolled ? "black" : background} py-2 duration-300 max-md:hidden`}>
            <div className={styles.nav + " container w-11/12 mx-auto flex items-center justify-between"}>
                <div className={styles.headerContact + " flex items-center gap-3"}>
                    <div className={styles.item + " flex items-center gap-1"}>
                        ...
                        <p className="text-white text-xs">۰۹۱۲۸۸۷۱۸۰۰</p>
                    </div>
                    <div className={styles.item + " flex items-center gap-1"}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="14" viewBox="0 0 13 14" fill="none">
                            <g clip-path="url(#clip0_717_2259)">
                ...
                <div className={styles.navList}>
                    <ul className="flex items-center gap-5">
                        ...
                        <li>
                            <Link className="text-[#FF0000] text-[14px] duration-300 hover:text-[#FF0000]" to={"/shop/"}>فروشگاه</Link>
                        </li>
                        <li>
                            <Link className="text-white text-[14px] duration-300 hover:text-[#FF0000]" to={"/blog"}>بلاگ</Link>
                        </li>
                        <li>
